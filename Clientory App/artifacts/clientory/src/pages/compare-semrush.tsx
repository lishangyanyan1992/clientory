...
const data: ComparisonPageData = {
  ...
  features: [
    ...
    { feature: "Starting price", clientory: "Free report; then $20/mo billed on upgrade", competitor: "$99/domain/mo billed annually" },
  ...
  faqs: [
    { question: "Do I need a separate Semrush SEO subscription?", answer: "Semrush currently sells AI Visibility as a per-domain product. Confirm its checkout terms for your account. Clientory is standalone: one free report with no card, followed by an optional $20 monthly subscription billed immediately on upgrade." },
