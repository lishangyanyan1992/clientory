...
const data: ComparisonPageData = {
  ...
  features: [
    ...
    { feature: "Starting price", clientory: "Free report; then $20/mo billed on upgrade", competitor: "$29/mo" },
  ...
  faqs: [
    ...
    { question: "Which tool is cheaper?", answer: "Clientory gives each user account one free report with no card. Its optional paid plan costs $20 per month and is billed immediately on upgrade. Otterly.ai currently starts at $29 per month." },
