...
const data: ComparisonPageData = {
  ...
  features: [
    ...
    { feature: "Starting price", clientory: "Free report; then $20/mo billed on upgrade", competitor: "$95/mo" },
  ...
  pricingRows: [
    ...
    { label: "Starter", clientory: "$20/mo, billed immediately on upgrade", competitor: "$95/mo" },
