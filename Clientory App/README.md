...
| `COMPETITOR_GAPS_ENABLED` | `false` | Enables post-scan competitor discovery from stored AI answers |
| `COMPETITOR_EXTRACTION_MODEL` | `claude-haiku-4-5` | Anthropic model used to extract explicitly named firms from scan answers |
